...
$extra_style = '<link rel="stylesheet" href="style/about-style.css">';
include 'header.php';
...
<div class="about-section">
	<div class="column" id="motto">
		"The greatest assurance of quality we can give is a <em>genuine passion</em> for our craft."
	</div>
	<div class="column">
	...
	<div class="column">
		...
		<br><br>
		We love what we do. We are proud of what we make. For this reason, the products that we sell are the very same ones we use. In adopting a "back to the basics" movement, we champion the elegant simplicity of handmade artisan craft that is created with the well-being of others in mind. Everything is natural, everything is fresh. That is our Homeroot Creations promise to you.<br><br>
	</div>
</div>
