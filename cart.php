...
//CASE 2: SHOPPING CART IS NOT EMPTY, LOOP THROUGH EACH ENTRY
	...
	$pp_checkout .= '
			...
			<input type = "hidden" name = "notify_url" value = "homerootcreations.com/listener.php">
			...
			<input type = "hidden" name = "return" value = "homerootcreations.com/success.php">
			<input type = "hidden" name = "cancel_return" value = "homerootcreations.com/cancel.php">
