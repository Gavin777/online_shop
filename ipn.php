...
if ($receiver_email != "homerootcreations-facilitator@gmail.com") {
...
$duplicate_result = mysqli_query($link, $duplicate_query);
$duplicate_num_rows = mysqli_num_rows($duplicate_result);
...
$sql = mysqli_query($link, $query) or die ("unable to execute the query");
